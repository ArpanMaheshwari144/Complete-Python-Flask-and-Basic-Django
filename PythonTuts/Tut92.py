...
# email:"deepak@dt.com"
# email:"armanmaliksmartcool@gmail.com"
# email:"maheshwariarpan828@gmail.com"
# email:"arpanmah123@gmail.com"
# and some more
# email id:<dt@codewithharry.com>
# email:"deepak@dt.com.in" and I have one more harrybhai@codewithharry.com.
# '''
#
# #\w+ ->(characters from a to Z and A to Z, digits from 0-9, and the underscore _ character) one or more occurences
# #\S+ -> returns a match jab white space character na ho
...
# email = re.findall(r"[0-9a-zA-Z._+%]+@[0-9a-zA-Z._+%]+[.][a-zA-Z.0-9]+", str)     # [0-9a-zA-Z._+%]+ means ke ho bhi group mei hai uske ek ya ek se zyda occurence honi chahiye
email = re.findall(r"[a-zA-Z0-9_.-]+@[a-zA-Z0-9_.-]+\.[a-zA-Z]+",str)
op=open("myemail_store.txt","a")
j=1
for i in email:
    op.write(f"Email{j}:{i}\n")
    j=j+1
op.close()
print(f"Email's are:{email}")
print(f"Total Email's are:{j-1}")
