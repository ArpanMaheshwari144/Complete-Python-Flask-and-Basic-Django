...
if __name__ == '__main__':
    ...
    Label(root, text="Created By Arpan Maheshwari", font="lucida 10", bg="grey", fg="white").pack(fill=X, pady=25)
    Label(root, text="#ArpanMusic", font="lucida 10", bg="black", fg="white").pack()
